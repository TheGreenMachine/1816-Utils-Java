 ...
 * to be exactly zero.
 */
public class GamepadDeadzoneFilter extends SimpleGamepadFilter {
    private final double radius;
    
    /**
     * Constructs a new GamepadDeadzoneFilter that applies a deadzone of a given
     * radius.
     * @param radius The size of the deadzone to apply in this filter.
     */
    public GamepadDeadzoneFilter(double radius){
        this.radius = radius;
    }
