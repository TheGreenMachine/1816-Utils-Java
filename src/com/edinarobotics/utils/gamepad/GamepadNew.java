...
import com.edinarobotics.utils.gamepad.buttons.DPadButtonNew;
...
public class GamepadNew {
	...
	public GamepadNew(int port) {
        ...
        dPadLeft = new DPadButtonNew(this, DPadButtonNew.DPadButtonType.LEFT);
        dPadRight = new DPadButtonNew(this, DPadButtonNew.DPadButtonType.RIGHT);
        dPadUp = new DPadButtonNew(this, DPadButtonNew.DPadButtonType.UP);
        dPadDown = new DPadButtonNew(this, DPadButtonNew.DPadButtonType.DOWN);
