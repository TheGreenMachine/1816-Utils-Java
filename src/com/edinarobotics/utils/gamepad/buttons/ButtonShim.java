...
public class ButtonShim {
    ...
    /**
     * Constructs a new active ButtonShim that uses the given
     * internal button.
     * @param internalButton The button to be used internally by the
     * ButtonShim.
     */
    ...
    /**
     * Constructs a new inactive ButtonShim that discards
     * all method calls.
     */
    public ButtonShim(){
     ...
     * @param command The command to be forwarded to the internal button
     * of this button shim.
